...
exports.EyelashesOption = new Option_1.default({
    key: 'eyelashType',
    label: 'Eyelashes',
});
...
exports.FrecklesOption = new Option_1.default({
    key: 'freckleType',
    label: '🎨 Freckling',
});
exports.YseqlogoOption = new Option_1.default({
    key: 'yseqlogoType',
    label: 'Yseqlogo',
});
exports.allOptions = [
    ...
    exports.EyesOption,
    exports.EyelashesOption,
    exports.EyebrowOption,
    exports.MouthOption,
    exports.SkinOption,
    exports.FrecklesOption,
    exports.YseqlogoOption
];
