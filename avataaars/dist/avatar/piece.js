...
var eyelashes_1 = require("./face/eyelashes");
var eyebrow_1 = require("./face/eyebrow");
var mouth_1 = require("./face/mouth");
var nose_1 = require("./face/nose");
var Skin_1 = require("./Skin");
var freckles_1 = require("./face/freckles");
var yseqlogo_1 = require("./yseqlogo");
var AvatarStyle;
...
var PieceComponent = /** @class */ (function (_super) {
    ...
    PieceComponent.prototype.render = function () {
        return (React.createElement("svg", { style: this.props.style, width: this.props.pieceSize + "px", height: this.props.pieceSize + "px", viewBox: "0 0 264 280", version: "1.1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink" },
            ...
            this.props.pieceType === 'eyelashes' && React.createElement(eyelashes_1.default, null),
	    ...
	    this.props.pieceType === 'freckles' && React.createElement(freckles_1.default, null),
	    this.props.pieceType === 'yseqlogo' && React.createElement(yseqlogo_1.default, null),
