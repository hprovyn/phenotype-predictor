...
var Vampire_1 = require("./Vampire");
var Blue_1 = require("./Blue");
var Brown_1 = require("./Brown");
var Intermediate_1 = require("./Intermediate");
...
var Eyes = /** @class */ (function (_super) {
    ...
    Eyes.prototype.render = function () {
        return (React.createElement(options_1.Selector, { defaultOption: Default_1.default, option: options_1.EyesOption },
            ...
            React.createElement(Vampire_1.default, null),
            React.createElement(Blue_1.default, null),
            React.createElement(Brown_1.default, null),
            React.createElement(Intermediate_1.default, null),
