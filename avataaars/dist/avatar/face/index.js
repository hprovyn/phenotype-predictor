...
var eyelashes_1 = require("./eyelashes");
var mouth_1 = require("./mouth");
var Default_1 = require("./nose/Default");
var freckles_1 = require("./freckles");
var Face = /** @class */ (function (_super) {
    ...
    Face.prototype.render = function () {
	    ...
	    React.createElement(eyelashes_1.default, null),
	    React.createElement(freckles_1.default, null),
